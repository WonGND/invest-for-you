...
export function IndicatorCard({
  ...
  return (
    <button
      onClick={onClick}
      className="text-left rounded-lg bg-[color:var(--surface)] border border-border p-4 flex flex-col gap-1 hover:border-[color:var(--primary)]/60 hover:bg-[color:var(--surface-2)] transition-all cursor-pointer"
    >
